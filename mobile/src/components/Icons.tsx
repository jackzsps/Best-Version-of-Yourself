...
const iconPaths: Record<string, (props: any) => JSX.Element> = {
  ...
  apple: (props) => (
    <>
      <Path d="M12 2C6.477 2 2 6.477 2 12c0 5.523 4.477 10 10 10s10-4.477 10-10c0-5.523-4.477-10-10-10z" {...props} />
      <Path d="M15.5 17c2.485 0 4.5-2.015 4.5-4.5S17.985 8 15.5 8 11 10.015 11 12.5s2.015 4.5 4.5 4.5zM8.5 17c2.485 0 4.5-2.015 4.5-4.5S10.985 8 8.5 8 4 10.015 4 12.5 6.015 17 8.5 17z" {...props} />
    </>
  ),
  dollar: (props) => (
    <>
