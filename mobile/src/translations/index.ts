// Copied from shared/translations.ts
  ...
  en: {
    ...
    dashboard: {
      ...
      insights: {
        title: 'AI Insights',
        spendingRise:
          "You've spent {percent}% more on '{usage}' categories this month compared to last.",
        spendingFall:
          "Great job! You've reduced '{usage}' spending by {percent}% compared to last month.",
        proteinLow:
          'Protein intake is averaging low ({amount}g/day). Consider adding more lean meats or beans.',
        proteinGood:
          'Excellent protein intake! You are averaging {amount}g per day.',
        generalTip:
          'Keep tracking your daily habits to unlock personalized insights.',
      },
      reports: {
        overview: 'Overview',
        expense: 'Finance',
    ...
    settings: {
      ...
      signOut: 'Sign Out',
      logoutWarning:
        'A write operation is in progress. Please wait for it to complete.',
      authDesc:
        'Sign in to sync your records to the cloud, ensuring data safety and cross-device access.',
      language: 'Language',
      ...
      standardDesc:
        'When AI detects a range of values (e.g., 500-600 calories), how should we record it automatically?',
      strict: 'Strict (Recommended)',
      strictDesc:
        "Records the maximum detected value. Best for ensuring you don't underestimate calorie intake.",
      conservative: 'Conservative',
  ...
  'zh-TW': {
    ...
    dashboard: {
      ...
      insights: {
        ...
        spendingFall:
          '做得好！本月在「{usage}」類別的支出比上個月減少了 {percent}%。',
        proteinLow:
          '最近蛋白質攝取偏低 (平均每日 {amount}克)。建議多補充瘦肉或豆類。',
    ...
    settings: {
      ...
      standard: '紀錄標準',
      standardDesc:
        '當 AI 偵測到數值區間（例如 500-600 大卡）時，自動紀錄的標準。',
      strict: '偏重口（推薦）',
